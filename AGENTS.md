...
2. Read `PROTOCOLS.md` — non-negotiable operating rules (DIN, team, routing, hard rules)
3. Read `USER.md` — this is who you're helping
4. Read `memory/core/active-tasks.md` — current task board
...
For business execution workflow, proof, MC-first behavior, mock/test/prove/release, and duplicate protection, see:
- `docs/business-execution-harness.md`
